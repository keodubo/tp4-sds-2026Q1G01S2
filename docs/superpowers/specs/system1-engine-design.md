...
```bash
cd SdS_TP4_2026Q1G01CS2_Codigo
mvn exec:java -Dexec.args="system1 --m 70 --k 10000 --gamma 100 --tf 5 --x0 1 --v0 -0.7142857142857143 --dt 0.01,0.001,0.0001,0.00001,0.000001 --output ../outputs/system1.csv"
```
...
- default analytical-vs-numerical position comparison and zoom figures for `dt = 0.001`
